...
HEADERS = {"User-Agent": "MyBot/1.1 (https://example.com; contact@example.com)"}

# External URL for the color index image (update with your actual GitHub raw URL)
COLOR_INDEX_URL = "https://raw.githubusercontent.com/fectlk/iqair-data-scraper/main/assets/aqi_template.png"
