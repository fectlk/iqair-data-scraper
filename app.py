...
WEEKLY_CHARTS_FOLDER = "weekly_charts"
...
os.makedirs(WEEKLY_CHARTS_FOLDER, exist_ok=True)
...
def list_files():
    ...
    weekly_charts_files = os.listdir(WEEKLY_CHARTS_FOLDER)
    return {
        "all_stations_maps": all_stations_maps_files,
        "charts": charts_files,
        "weekly_charts": weekly_charts_files,
    }
...
def download_file(folder, filename):
    ...
    folder_paths = {
        ...
        "weekly_charts": WEEKLY_CHARTS_FOLDER,
    }
